...
export const industriesData: IndustrySEOData[] = [
  ...
  },
  {
    ...
    title: "Puragenda para consultas de psicología",
    description: "Cómo organizar las citas de una consulta de psicología con Puragenda: servicios, jornadas, bloqueos y reservas desde un enlace.",
    heroHeadline: "Cómo organizar las citas de tu consulta con Puragenda",
    heroSubheadline: "Configura tus tipos de cita, define la jornada de cada profesional y comparte una agenda clara para que las personas reserven una hora disponible.",
    benefits: [
      { title: "Servicios con duración propia", description: "Crea cada tipo de cita con el tiempo y el precio que defina el profesional." },
      { title: "Jornadas y bloqueos", description: "Organiza horarios individuales y marca períodos en que no quieres recibir reservas." },
      { title: "Reserva desde un enlace", description: "Comparte la agenda o su widget para que la persona elija servicio, profesional y hora disponible." },
    ],
    faq: [
      { question: "¿Cómo configuro los tipos de cita?", answer: "Crea cada servicio con el nombre, duración y precio que defina el profesional. Después puedes asignarlo a quienes lo ofrecen." },
      { question: "¿Cómo preparo una jornada con horas no disponibles?", answer: "Define la jornada de cada profesional y añade bloqueos para pausas, reuniones, vacaciones u otros períodos sin atención." },
      { question: "¿Puedo revisar reservas anteriores?", answer: "Sí. El panel muestra el historial administrativo de citas y los servicios agendados, sin convertirlo en documentación clínica." },
      { question: "¿Dónde evalúo el software completo?", answer: "La landing comercial de software de agenda para psicólogos explica el flujo, las funciones y los planes generales de Puragenda." },
    ],
    keywords: ["organizar citas consulta psicológica", "agenda de citas psicólogo", "reservas consulta de psicología"],
    relatedSlugs: ["clinicas"],
    softwareHub: {
      href: "/software-agenda-psicologos",
      title: "Software de agenda para psicólogos",
      description: "Evalúa el flujo comercial para organizar servicios, profesionales y reservas de tu consulta.",
      context: "consulta el ejemplo ficticio, los límites administrativos, las integraciones y los planes generales.",
    },
  },
  {
    slug: "kinesiologos",
