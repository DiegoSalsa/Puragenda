        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="space-y-3">
            <Link href="/" className="flex items-center gap-2.5 mb-6">
              <Image src="/logos/logoPuragendaSVG.svg" alt="Puragenda" width={166} height={95} className="h-12 w-auto scale-[1.3] origin-left" />
            </Link>
          ...
          {/* Casos de Uso */}
          <div className="space-y-3">
            <p className="text-sm font-semibold">{footer("useCases")}</p>
            <nav className="flex flex-col gap-2">
              <Link href="/para/peluquerias" className="text-sm text-muted-foreground transition-colors hover:text-foreground">{footer("hairSalons")}</Link>
              <Link href="/para/estetica" className="text-sm text-muted-foreground transition-colors hover:text-foreground">{footer("beautySpa")}</Link>
              <Link href="/para/barberias" className="text-sm text-muted-foreground transition-colors hover:text-foreground">{footer("barbershops")}</Link>
              <Link href="/para/clinicas" className="text-sm text-muted-foreground transition-colors hover:text-foreground">{footer("clinics")}</Link>
            </nav>
          </div>
