...
export function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 w-full z-50 border-b border-border bg-background/80 backdrop-blur-xl">
      ...
      {mobileOpen && typeof document !== "undefined" &&
        createPortal(
          <div className="fixed inset-0 z-[9999] md:hidden">
            ...
            />
            {/* Drawer panel — opaque bg, outside header's backdrop-blur context */}
            <aside className="absolute right-0 top-0 flex h-full w-72 max-w-[85vw] flex-col border-l border-border z-[10000] shadow-2xl animate-drawer-right bg-white dark:bg-[#0A0A0A]">
              {/* Header */}
