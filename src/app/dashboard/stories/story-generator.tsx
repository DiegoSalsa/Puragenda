...
export function StoryGenerator({
  ...
  return (
    <div className="mx-auto min-w-0 max-w-[1440px] space-y-8 pb-[calc(7rem+env(safe-area-inset-bottom))] lg:space-y-10">
      <section
      ...
      <div className="fixed inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-40 flex gap-2 rounded-full border-2 border-[#171717] bg-white p-2 text-[#171717] shadow-[5px_5px_0_#171717] dark:border-border dark:bg-card dark:text-foreground xl:hidden">
        <button
          type="button"
          disabled={loading || !formValid}
          onClick={() => void generatePreview()}
