      ...
      <MarketplaceEditor
        business={{
          ...
          listings: editor.business.marketplaceListings.map((listing) => ({
            ...
            authorizationConfirmedAt: listing.authorizationConfirmedAt?.toISOString() ?? null,
            authorizationRevokedAt: listing.authorizationRevokedAt?.toISOString() ?? null,
            authorizationTextVersion: listing.authorizationTextVersion,
            pendingCategoryDescription: listing.pendingCategoryDescription,
            pendingLocalityName: listing.pendingLocalityName,
