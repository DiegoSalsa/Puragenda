        ...
        <div className="rounded-2xl border border-white/[0.06] bg-[#0e0e12] p-6 shadow-2xl">
          ...
          {step === "email" ? (
            <form className="space-y-4" onSubmit={handleEmailSubmit}>
              ...
              <label className="flex cursor-pointer items-start gap-2.5 rounded-xl border border-white/[0.06] bg-[#141418] px-3 py-2.5">
                <input
                  type="checkbox"
                ...
                <span className="space-y-0.5">
                  <span className="block text-xs font-medium text-white">
                    Mantener sesión en este dispositivo durante 30 días
                  </span>
                  {rememberDevice ? (
                    <span className="block text-[11px] text-[#888]">
                      Este dispositivo permanecerá conectado durante 30 días.
                    </span>
                  ) : (
                    <span className="block text-[11px] text-[#888]">
                      La sesión caducará en 8 horas.
                    </span>
                  )}
                </span>
              </label>
