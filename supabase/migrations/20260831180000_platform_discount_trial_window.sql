...
ALTER TABLE public."PlatformDiscountCode"
  ADD COLUMN IF NOT EXISTS "trialEndsAtFrom" TIMESTAMP(3),
  ADD COLUMN IF NOT EXISTS "trialEndsAtTo" TIMESTAMP(3);
...
UPDATE public."PlatformDiscountCode"
SET
